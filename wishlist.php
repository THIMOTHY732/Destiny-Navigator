...
<!-- third child-->
<div class="bg-light">
  <h3 class="text-center">Destiny <span style="color:#3ebcc9">Navigator</span></h3>
      ...
      <form action="" method="post">
        <table class="table table-bordered text-center">
                ...
                <?php 
                  ...
                  $total_price=0;
                  $cart_query="Select * from `wishlist_details` where ip_address='$get_ip_add' ";
                ...
                <tr>
                    ...
                    <?php
                     ...
                     if(isset($_POST['update_wishlist'])){
                      ...
                      $update_cart="update `wishlist_details` set quantity=$quantities where product_id=$product_id";
                    ...
                    <td>
                        ...
                        <input type="submit" value="Update wishlist" class="bg-info px-3 py-2 border=0 mx-3" name="update_wishlist">
                        <!-- <button class="bg-info px-3 py-2 border=0 mx-3">Remove</button>-->
                        <input type="submit" value="Remove wishlist" class="bg-info px-3 py-2 border=0 mx-3" name="remove_wishlist">
                ...
                echo "<h2 class='text-center text-danger'>Wishlist is Empty</h2>";
              }
              ?>
            </tbody>
</table>
...
function remove_wishlist_item(){
  ...
  if(isset($_POST['remove_wishlist'])){
    foreach($_POST['removeitem'] as $remove_id){
      echo $remove_id;
      $delete_query="Delete  from `wishlist_details` where product_id=$remove_id";
